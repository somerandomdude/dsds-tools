...
> - **Still open:** npm publish + naming (§10.2 — `dsds` squatted, `@sanity-labs/dsds` free; PJ's call), CI wiring (§10.5), lint plugin install location (Phase 3 doctor finding), search tokenization (Phase 4 demo note).
