...
// Requires a package (or a package subpath) from the consuming projectest/box')
...
// lint-code.js (ESLint plugins
// packages) so both resolve consumer-supplied packages the same way.
/** Import a package (or subpath) resolved from the consuming project, not from this one. */
