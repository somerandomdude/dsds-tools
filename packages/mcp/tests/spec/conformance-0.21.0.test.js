...
//
// The manifest and fixtures are vendored verbatim from tag 0.21.0 alongside
...
const FIXTURE_DIR = resolve(__dirname, '../fixtures/conformance-0.21.0');
...
describe(`DSDS conformance suite v${suite.schemaVersion}`, () => {
  it('vendors every fixture the manifest declares', () => {
    ...
    expect(suite.schemaVersion).toBe('0.21.0');
  });
